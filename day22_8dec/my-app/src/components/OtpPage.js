    ...
    return (
        <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '60vw', padding: '20px', backgroundColor: 'white', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)' }}>
                ...
                <div style={{ fontSize: '12px', color: '#777', marginBottom: '10px' }}>* Indicates a required field</div>
                {error && <div className="error-message" style={{ color: 'red', fontSize: '14px', textAlign: 'center' }}>Please fill in both fields.</div>}
                <form>
